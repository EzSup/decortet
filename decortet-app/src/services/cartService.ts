...
export function setCart(arg1 : ProductWithCount[] | Product[], arg2?: number[]):void{
  if(Array.isArray(arg1) && arg2){
    ...
    localStorage.setItem(cartLocalStorageName, JSON.stringify(productsWithCount));
  }
}
...
function convertToProductWithCount (products: Product[], quantities: number[] = []): ProductWithCount[] {
