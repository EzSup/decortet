...
import { Truck , CurrencyCircleDollar, ClockClockwise, InstagramLogo} from '@phosphor-icons/react'
    ...
    <div style={{ fontFamily: '"Montserrat", sans-serif' }}>
      <section id='header' className='header m-0 content-center justify-center'>
        <div className='header-content'>
          <h1>
            <img src='../src/assets/logo-nobg.svg' width={70} style={{ marginBottom: "-10px", marginRight: "-5px" }} />
            ecortet
          </h1>
